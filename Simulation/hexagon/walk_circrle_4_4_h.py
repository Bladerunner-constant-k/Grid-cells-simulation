...
for i in range(n):
    for i in range(n):
        i = i
        if i // 4 == 0:
            point_x[i] = -1 * length + length_setion * (i % 4) + length_setion
            point_y[i] = length - length_setion - length_setion * (i // 4)
        if i // 4 == 1:
            point_x[i] = -1 * length + length_setion * (i % 4) + length_setion + (length_setion / np.sqrt(3))
            point_y[i] = length - length_setion - length_setion * (i // 4)
        if i // 4 == 2:
            point_x[i] = -1 * length + length_setion * (i % 4) + length_setion
            point_y[i] = length - length_setion - length_setion * (i // 4)
