...
for i in range(n):
    i = i
    if i // 2 == 0:
        point_x[i] = -1 * length + length_setion * (i % 2) + length_setion
        point_y[i] = length - length_setion - length_setion * (i // 2)
    if i // 2 == 1:
        point_x[i] = -1 * length + length_setion * (i % 2) + length_setion + (length_setion/ np.sqrt(3))
        point_y[i] = length - length_setion - length_setion * (i // 2)
