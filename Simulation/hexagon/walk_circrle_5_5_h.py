...
for i in range(n):
    i = i
    if i // 5 == 0:
        point_x[i] = -1 * length + length_setion * (i % 5) + length_setion
        point_y[i] = length - length_setion - length_setion * (i // 5)
    if i // 5 == 1:
        point_x[i] = -1 * length + length_setion * (i % 5) + length_setion + (length_setion / np.sqrt(3))
        point_y[i] = length - length_setion - length_setion * (i // 5)
    if i // 5 == 2:
        point_x[i] = -1 * length + length_setion * (i % 5) + length_setion
        point_y[i] = length - length_setion - length_setion * (i // 5)
...
# density_d = nsteps / (np.pi * 100 * radius ** 2) * 0.15
